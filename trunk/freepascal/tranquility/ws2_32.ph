...
function connect(s : TSOCKET; name : LPSOCKADDR_IN; namelen : INT) : INT;WS2_32_DLL;

function send(s : TSOCKET; buf : PCHAR; len : INT; flags : INT) : INT;WS2_32_DLL;
function sendto(s : TSOCKET; buf : PCHAR; len : INT; flags : INT; toaddr : LPSOCKADDR_IN; tolen : INT) : INT;WS2_32_DLL;

function recvfrom(s : TSOCKET; buf : PCHAR; len : INT; flags : INT; from : LPSOCKADDR_IN; fromlen : PINT) : INT;WS2_32_DLL;

function gethostbyname(name : PCHAR) : LPHOSTENT;WS2_32_DLL;
